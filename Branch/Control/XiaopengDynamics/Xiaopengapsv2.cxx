...
class Xiaopengaps : public icvFunction
{
  public:
	...
	{
		load_curvemap(); //导入地图
		outvalue=new data::icvDoubleData();
        Register_Pub("Steering_Angle");
  ...
  virtual void Execute() override
	{
		icvSubscribe("GPS_data",&GPS_DATA);
...
ICV_LOG_INFO<<"IMU DATA:"<<imu_data.linear_acceleration.z;
		...
		* 控制
		...
		outvalue->setvalue(strangle);
		icvPublish("Steering_Angle",outvalue);
