...
#ifndef __Can_SCU_IPC_1_0x204_H__
#define __Can_SCU_IPC_1_0x204_H__

#include "structureCanXP.h"

class  Can_SCU_IPC_1_0x204
{
public:
  ...
  CanFrame_SCU_IPC_1_0x204* data() {return &data_; }; 
  int size() { return sizeof(CanFrame_SCU_IPC_1_0x204); };
  void SetData(TimestampedCanFrame rec_frame){d_=rec_frame;};
protected:

private:
  CanFrame_SCU_IPC_1_0x204 data_;
  TimestampedCanFrame d_;
};    //end of class  Can_SCU_IPC_1_0x204

#endif    //end of __Can_SCU_IPC_1_0x204_H__
