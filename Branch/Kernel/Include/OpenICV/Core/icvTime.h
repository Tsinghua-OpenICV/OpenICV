...
namespace icv
{
    ...
    struct icvTime
    {
        ...
        typedef icv_chrono::time_point<icvTime> time_point;
                typedef icv_chrono::time_point<icvTime,Duration32> time_point_s;
         typedef icv_chrono::time_point<icvTime,Duration32ms> time_point_ms;
    typedef icv_chrono::time_point<icvTime,Duration64us> time_point_us;
