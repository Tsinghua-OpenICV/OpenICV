...
class FeatureTracker : public icvFunction 
{
public:
    
    FeatureTracker(icv_shared_ptr<const icvMetaData> info);
    virtual ~FeatureTracker(void);
...
ICV_REGISTER_FUNCTION(FeatureTracker)