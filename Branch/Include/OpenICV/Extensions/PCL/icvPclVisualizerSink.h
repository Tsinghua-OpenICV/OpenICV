#ifndef icvPclVisualizerSink_h
#define icvPclVisualizerSink_h
...
namespace icv
{
    namespace pcl
    {
        ...
        class icvPclVisualizerSink : public icvFunction
        {
        public:
        typedef ::pcl::PointCloud<::pcl::PointXYZI> Cloud;
		typedef typename Cloud::ConstPtr CloudConstPtr;
        typedef typename Cloud::Ptr CloudPtr;
            icvPclVisualizerSink();
            icvPclVisualizerSink(icv_shared_ptr<const icvMetaData> info);
