                                ...
                                Imu &msg_imu, Odometry &msg_odom, const std::string &frame_id, const std::string &frame_id_vel)
{
  ...
  if (packet->nav_status == 4)
  {
    ...
    msg_fix.heading=packet-> heading;
  ...
  virtual void Process(std::istream &stream) override
  {
    ...
    if (_buffer.size() % 72 == 0)
    {
      ...
      while (!stream.eof())
      {
        ...
        //  ICV_LOG_INFO <<setprecision(10)<< "  imu data latitude:" << msg_fix.latitude*111194;
        //  ICV_LOG_INFO  <<setprecision(10)<< "  imu data longititude:" << msg_fix.longitude*111194;
