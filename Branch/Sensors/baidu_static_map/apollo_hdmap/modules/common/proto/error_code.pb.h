...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_modules_2fcommon_2fproto_2ferror_5fcode_2eproto_metadata_getter(int index);
namespace apollo {
namespace common {
class StatusPb;
...
class StatusPb PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_modules_2fcommon_2fproto_2ferror_5fcode_2eproto_metadata_getter(kIndexInFileMessages);
  }
