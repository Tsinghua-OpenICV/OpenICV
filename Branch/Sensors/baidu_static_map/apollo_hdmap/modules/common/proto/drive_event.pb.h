...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_modules_2fcommon_2fproto_2fdrive_5fevent_2eproto_metadata_getter(int index);
namespace apollo {
namespace common {
class DriveEvent;
...
class DriveEvent PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_modules_2fcommon_2fproto_2fdrive_5fevent_2eproto_metadata_getter(kIndexInFileMessages);
  }
