...
descriptor_table_modules_2fcommon_2fproto_2fpnc_5fpoint_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_modules_2fcommon_2fproto_2fpnc_5fpoint_2eproto);
  return descriptor_table_modules_2fcommon_2fproto_2fpnc_5fpoint_2eproto.file_level_metadata[index];
}
