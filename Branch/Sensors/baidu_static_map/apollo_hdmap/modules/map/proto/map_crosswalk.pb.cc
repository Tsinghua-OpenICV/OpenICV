...
descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto);
  return descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto.file_level_metadata[index];
}
