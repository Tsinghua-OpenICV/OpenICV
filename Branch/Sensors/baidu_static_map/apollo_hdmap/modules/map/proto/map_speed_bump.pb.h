...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_modules_2fmap_2fproto_2fmap_5fspeed_5fbump_2eproto_metadata_getter(int index);
namespace apollo {
namespace hdmap {
class SpeedBump;
...
class SpeedBump PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_modules_2fmap_2fproto_2fmap_5fspeed_5fbump_2eproto_metadata_getter(kIndexInFileMessages);
  }
