...
public:
	...
	void visual()
	{
		...
		//cv::waitKey(10);
        data::icvCvMatData datatosend(ldw_visual);
        icvPublish("ldw_visual",&datatosend);//=mFrame;
	}
    ...
    virtual void Execute() override
    {
        ...
        icvvel veldata;
        icvSubscribe("vel_data",&veldata);

		//cout<<"debug incoming criteria:  "<<lanedata.is_not_empty()<<" and "<<veldata.is_not_empty()<<endl;
        if (lanedata.is_not_empty()&&veldata.is_not_empty())
		{
