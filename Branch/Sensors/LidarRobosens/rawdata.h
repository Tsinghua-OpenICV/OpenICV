...
#ifndef _RSLIDARRAWDATA_H
#define _RSLIDARRAWDATA_H
...
public:
  ...
  void loadConfigFile(Config_RSlidar& config);
  /*unpack the RS16 UDP packet and opuput PCL PointXYZI type*/
  void unpack(const RSlidarPacket& pkt, ::pcl::PointCloud<::pcl::PointXYZI>::Ptr pointcloud);

  /*unpack the RS32 UDP packet and opuput PCL PointXYZI type*/
  void unpack_RS32(const RSlidarPacket& pkt, ::pcl::PointCloud<::pcl::PointXYZI>::Ptr pointcloud);
  ...
  void processDifop(const boost::shared_ptr<RSlidarPacket>& difop_msg);
