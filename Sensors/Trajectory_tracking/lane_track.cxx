...
//         icvNodeOutput* output_con= inputPorts[0]->GetConnections()[0];
// 	     bool correct;
...
//         icvNodeOutput* output_con1= inputPorts[1]->GetConnections()[0];
...
count_++;
    chatcallback1(read_Input<data::icvStructureData<donnees_gps>>(0)) ;
    chatcallback2(read_Input<data::icvStructureData<veh_info>>(1));
...
if(count_==0)
{
	...
	flag=flag+1;
    dataoutlock.lock();
   send_Output<data::icvDoubleData>(0)=wheel_angle_degree_next;
    send_Output<data::icvInt32Data>(1)=flag_end;
   dataoutlock.unlock();
	//topic:ACC_brake
        acc_off=flag_end;
        //topic:y_draw
