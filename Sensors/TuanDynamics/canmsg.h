...
public:
  ...
  ~canmessages();
  void receive_run();
  void send_run(float acclerationIn, float steeringAngleIn, float steeringtorqueIn, int steer_control_flag);  // the entryrun
  void reset(int setnumber);//added by wwu
