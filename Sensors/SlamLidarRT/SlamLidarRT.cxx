...
class SlamLidarFunction : public icvFunction
{
	...
	// //	for (icvNodeOutput* connection : inputPorts[0]->GetConnections())
...
buff_Output(outputPorts);
			...
			icv::pcl::icvPointCloudData<::pcl::PointXYZI>& points=read_Input<icv::pcl::icvPointCloudData<::pcl::PointXYZI>>(0);
