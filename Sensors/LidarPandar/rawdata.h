...
public:
     ...
     */
    int setup(Config_pandar & config);
    ...
    void unpack(const PandarPacket &pkt, PPointCloud &pc);
    int unpack(const  PandarScanConstPtr &scanMsg, PPointCloud &pc, time_t& gps1 , 
                                            gps_struct_t &gps2 , double& firstStamp, int& lidarRotationStartAngle);

    int unpack(PandarPacket &packet, PPointCloud &pc, time_t& gps1 , 
                                            gps_struct_t &gps2 , double& firstStamp, int& lidarRotationStartAngle);
