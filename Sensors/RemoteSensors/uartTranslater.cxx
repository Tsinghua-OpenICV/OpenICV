...
pt::ptree temp_pt;
    ...
    values.get_child(KEY_ACTUATOR).put("VehicleSpeed",to_string(wheel_speed.real_speed)) ;       // changed
    values.get_child(KEY_ACTUATOR).put("SteeringVelocity",to_string(siSteeringVelocity)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("TargetTorque",to_string(siTargetTorque)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("TargetBrakePressure",to_string(siTargetBrakePressure)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("BrakePressure",to_string(siBrakePressure)) ;;       // changed 
    values.get_child(KEY_ACTUATOR).put("SteeringTorqueVoltage",to_string(siSteeringTorqueVoltage)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("TargetSteeringAngle",to_string(siTargetSteeringAngle)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("TargetSteeringVelocity",to_string(siTargetSteeringVelocity)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("SteeringDAC_A",to_string(siSteeringDAC_A)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("SteeringDAC_B",to_string(siSteeringDAC_B)) ;;       // changed
    values.get_child(KEY_ACTUATOR).put("AcceleratorPedal",to_string(siAcceleratorPedal)) ;;       // changed
