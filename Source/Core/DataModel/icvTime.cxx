...
namespace icv
{
    ...
    static SyncClock::duration _offset = SyncClock::duration(0);
    bool SyncClock::is_synced() { return _synced; }
    void SyncClock::sync(const duration& offset)
    {
        _offset = offset;
        _synced = true;
    }
    SyncClock::time_point SyncClock::now()
    {
        return time_point(base_clock::now().time_since_epoch() + _offset);
    }

     SyncClock::time_point_s SyncClock::now_s()
    {
      ...
      SyncClock::time_point_ms SyncClock::now_ms()
    {
       // base_clock::time_point systime= base_clock::now(); 
       // Time64 offset_time(_offset);
       // //Time64(_offset);
       ...
       // Time32 time_32=icv_chrono::time_point_cast<Duration32>(time_64);
        ...
        return time_32ms;
          ...
          SyncClock::time_point_us SyncClock::now_us()
    {
       // base_clock::time_point systime= base_clock::now(); 
       // Time64 offset_time(_offset);
       // //Time64(_offset);
       ...
       // Time32 time_32=icv_chrono::time_point_cast<Duration32>(time_64);
        ...
        return time_64us;
         ...
         SyncClock::time_point SyncClock::now_ns()
    {
       // base_clock::time_point systime= base_clock::now(); 
       // Time64 offset_time(_offset);
       // //Time64(_offset);
       ...
       // Time32 time_32=icv_chrono::time_point_cast<Duration32>(time_64);
        ...
        return time_64;
           ...
           time_t SyncClock::time_ns()
    {

        return now_ns().time_since_epoch().count();
    }

           time_t SyncClock::time_us()
    {

        return now_us().time_since_epoch().count();
    }

           time_t SyncClock::time_ms()
    {

        return now_ms().time_since_epoch().count();
    }

           time_t SyncClock::time_s()
    {

        return now_s().time_since_epoch().count();
    }
    const SyncClock::duration& SyncClock::offset() { return _offset; }
}
