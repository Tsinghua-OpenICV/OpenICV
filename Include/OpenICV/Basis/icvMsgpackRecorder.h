...
namespace icv { namespace _impl
{
    ...
    public:
        ...
        virtual void Record(const icvDataObject* data, const Uint32& source) ICV_OVERRIDE;
         void Record(const icvDataObject* data, const Uint32& source,const Int64 timestamp ) ;
         void closefile() ;

        virtual void PlayNext(icvDataObject* data, const Uint32& source) ICV_OVERRIDE;
