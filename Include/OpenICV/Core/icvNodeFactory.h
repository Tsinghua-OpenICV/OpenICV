...
namespace icv { namespace core
{
    ...
    public:
        ...
        static icvNode* CreateNode(const std::string& type, icvFunction* function,
            ...
            icv_shared_ptr<const icvMetaData>* output_params,int num_inport,int num_outport)
        {
            return Registry()[type](function, params, input_params, output_params,num_inport, num_outport);
        }
...
{                                                                                 \
    ::icv::core::icvNode* _Creator_##type(::icv::core::icvFunction* function,     \
        ...
        icv_shared_ptr<const icvMetaData>* output_params,int num_inport,int num_outport)                         \
    {                                                                             \
        return new type(function, params, input_params, output_params,num_inport,num_outport);           \
    }                                                                             \
